  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md flex flex-col gap-4">
        <div className="text-lg font-semibold text-gray-800 dark:text-gray-100">Multiple products found. Select one:</div>
          ...
          <table className="min-w-full text-left border rounded-lg text-gray-800 dark:text-gray-100">
            <thead className="bg-gray-800 dark:bg-gray-700">
              <tr>
                ...
                <th className="px-2 py-1 text-white">Select</th>
              </tr>
            </thead>
            <tbody>
              {options.map((p) => (
                <tr key={p.id} className="border-b last:border-b-0 dark:border-gray-700">
                  ...
                  <td className="px-2 py-1">
                    <button onClick={() => onSelect(p)} className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition">Select</button>
                  </td>
                </tr>
              ))}
            </tbody>
