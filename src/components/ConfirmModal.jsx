      ...
      <div className="flex flex-col gap-6 items-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
        ...
        <div className="flex gap-4 mt-2 w-full justify-center">
          <button 
            ...
            className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-100 px-6 py-3 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors font-medium border border-gray-300 dark:border-gray-600"
          >
            {t.cancel}
          </button>
          <button 
            onClick={handleConfirm} 
            className="flex-1 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium border border-blue-700"
            autoFocus
          >
            {t.ok}
          </button>
