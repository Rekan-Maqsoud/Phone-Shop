...
const translations = {
  en: {
    ...
    checkOnStartupDesc: 'Check for updates when the app starts',
    autoDownloadUpdates: 'Auto Download Updates',
    autoDownloadDesc: 'Automatically download updates (not recommended for production)',
    howUpdatesWork: 'How Updates Work',
    updatesInfo: 'Updates are fetched from the official repository. You will always be notified before any update is installed. The app will restart automatically after installation to apply the update.',
    newVersionAvailable: 'A new version is ready to download',
    updateDownloadedReady: 'The update has been downloaded and is ready to install',
    updatePreferences: 'Update Preferences',
    loadingSettings: 'Loading settings',
    failedToLoadSettings: 'Failed to load update settings',
  ...
  ku: {
    ...
    // Update Settings Section
    currentVersion: 'ڤێرژنی ئێستا',
    checkForUpdates: 'بگەڕێ بۆ نوێکردنەوە',
    checkingUpdates: 'گەڕان...',
    updateAvailable: 'نوێکردنەوە بەردەستە',
    updateReady: 'نوێکردنەوە ئامادەیە',
    downloadUpdate: 'داگرتنی نوێکردنەوە',
    installRestart: 'دامەزراندن و ڕێستارت',
    downloadingUpdate: 'داگرتنی نوێکردنەوە',
    complete: 'تەواو',
    enableAutoUpdates: 'چالاککردنی نوێکردنەوەی خۆکار',
    autoUpdateDesc: 'خۆکارانە بگەڕێ بۆ نوێکردنەوە',
    checkOnStartup: 'گەڕان لە دەستپێکردندا',
    checkOnStartupDesc: 'گەڕان بۆ نوێکردنەوە کاتێک ئەپ دەستپێدەکات',
    autoDownloadUpdates: 'داگرتنی خۆکاری نوێکردنەوە',
    autoDownloadDesc: 'خۆکارانە نوێکردنەوەکان دابگرە (پێشنیارنەکراوە بۆ پرۆداکشن)',
    howUpdatesWork: 'چۆن نوێکردنەوەکان کاردەکەن',
    updatesInfo: 'نوێکردنەوەکان لە کۆگای فەرمییەوە وەردەگیرێن. هەمیشە ئاگادارت دەکرێیتەوە پێش دامەزراندنی هەر نوێکردنەوەیەک. ئەپ خۆکارانە ڕێستارت دەکات دوای دامەزراندن.',
    newVersionAvailable: 'ڤێرژنێکی نوێ ئامادەیە بۆ داگرتن',
    updateDownloadedReady: 'نوێکردنەوەکە داگیراوە و ئامادەیە بۆ دامەزراندن',
    updatePreferences: 'هەڵبژاردەکانی نوێکردنەوە',
    loadingSettings: 'بارکردنی ڕێکخستنەکان',
    failedToLoadSettings: 'شکستی بارکردنی ڕێکخستنەکانی نوێکردنەوە',
    failedToCheckUpdates: 'شکستی گەڕان بۆ نوێکردنەوە',
    failedToStartDownload: 'شکستی دەستپێکردنی داگرتن',
    failedToInstallUpdate: 'شکستی دامەزراندنی نوێکردنەوە',
    updateSettingsSaved: 'ڕێکخستنەکانی نوێکردنەوە پاشەکەوت کرا',
    failedToSaveSettings: 'شکستی پاشەکەوتکردنی ڕێکخستنەکان',
    updateCheckFailed: 'گەڕانی نوێکردنەوە شکستی هێنا',
    updateDownloadStarted: 'داگرتنی نوێکردنەوە دەستیپێکرد',
    downloadFailed: 'داگرتن شکستی هێنا',
    installingUpdate: 'دامەزراندنی نوێکردنەوە',
    installationFailed: 'دامەزراندن شکستی هێنا',
    updateVersion: 'نوێکردنەوە',
    ...
    updateSettings: 'نوێکردنەوەی ئەپ',
  ...
  ar: {
    ...
    complete: 'مكتمل',
    enableAutoUpdates: 'تمكين التحديثات التلقائية',
    autoUpdateDesc: 'البحث تلقائياً عن التحديثات',
    checkOnStartup: 'البحث عند بدء التشغيل',
    checkOnStartupDesc: 'البحث عن التحديثات عند بدء تشغيل التطبيق',
    autoDownloadUpdates: 'تحميل التحديثات تلقائياً',
    autoDownloadDesc: 'تحميل التحديثات تلقائياً (غير مستحسن للإنتاج)',
    howUpdatesWork: 'كيف تعمل التحديثات',
    updatesInfo: 'يتم جلب التحديثات من المستودع الرسمي. ستتم إعلامك دائماً قبل تثبيت أي تحديث. سيعيد التطبيق تشغيل نفسه تلقائياً بعد التثبيت لتطبيق التحديث.',
    newVersionAvailable: 'إصدار جديد جاهز للتحميل',
    updateDownloadedReady: 'تم تحميل التحديث وهو جاهز للتثبيت',
    updatePreferences: 'تفضيلات التحديث',
    loadingSettings: 'جاري تحميل الإعدادات',
    failedToLoadSettings: 'فشل في تحميل إعدادات التحديث',
    failedToCheckUpdates: 'فشل في البحث عن التحديثات',
    failedToStartDownload: 'فشل في بدء التحميل',
    failedToInstallUpdate: 'فشل في تثبيت التحديث',
    updateSettingsSaved: 'تم حفظ إعدادات التحديث',
    failedToSaveSettings: 'فشل في حفظ الإعدادات',
    updateCheckFailed: 'فشل في فحص التحديثات',
    updateDownloadStarted: 'بدأ تحميل التحديث',
    ...
    updateSettings: 'تحديثات التطبيق',
