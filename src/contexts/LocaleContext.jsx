...
const translations = {
  ...
  ku: {
    ...
    logout: 'دەرچوون',
    passwordsDoNotMatch: 'وشەکان یەکناگرنەوە',
    authenticationFailed: 'دڵنیاکردنەوە سەرکەوتوو نەبوو',
    ...
    creating: 'دروستکردن...',
    refresh: 'نوێکردنەوە',
    cloudBackups: 'پاشەکەوتەکانی هەور',
    loading: 'بارکردن...',
  ...
  ar: {
    ...
    createCloudBackup: 'إنشاء نسخة احتياطية سحابية',
    backupName: 'اسم النسخة الاحتياطية',
    backupDescription: 'الوصف (اختياري)',
    backupDescriptionPlaceholder: 'أدخل وصفاً لهذه النسخة الاحتياطية...',
    leaveEmptyAutoName: 'اتركه فارغاً للاسم التلقائي',
    cloudBackups: 'النسخ الاحتياطية السحابية',
    noCloudBackups: 'لم يتم العثور على نسخ احتياطية سحابية',
    backupVersion: 'الإصدار',
    storageUsed: 'المساحة المستخدمة',
    downloadBackup: 'تحميل',
    deleteBackup: 'حذف',
    autoBackupSettings: 'إعدادات النسخ الاحتياطي التلقائي',
    enableAutoCloudBackup: 'تفعيل النسخ الاحتياطي السحابة التلقائي',
    uploadBackupSuccess: 'تم رفع النسخة الاحتياطية بنجاح!',
    uploadBackupFailed: 'فشل في رفع النسخة الاحتياطية',
    downloadStarted: 'بدأ التحميل',
    downloadBackupFailed: 'فشل في تحميل النسخة الاحتياطية',
    deleteBackupSuccess: 'تم حذف النسخة الاحتياطية بنجاح',
    deleteBackupFailed: 'فشل في حذف النسخة الاحتياطية',
    deleteBackupConfirm: 'هل أنت متأكد من حذف هذه النسخة الاحتياطية؟',
