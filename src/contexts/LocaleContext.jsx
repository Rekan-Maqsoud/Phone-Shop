...
const translations = {
  en: {
    ...
    backupDescriptionPlaceholder: 'Add a description for this backup...',
    leaveEmptyAutoName: 'Leave empty for auto-generated name',
    ...
    enableAutoCloudBackup: 'Enable automatic cloud backup',
    ...
    cloudAutoBackupEnabled: 'Auto backup enabled',
    cloudAutoBackupDisabled: 'Auto backup disabled',
    autoBackupSettingsFailed: 'Failed to update auto backup settings',
    ...
    cloudBackupIntro: 'Sign in to backup and restore your data securely in the cloud',
  },
  ku: {
  ...
  ar: {
    ...
    autoBackupFailed: 'فشل في تغيير إعدادات النسخ الاحتياطي التلقائي',
